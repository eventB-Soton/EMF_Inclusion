...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>inclusion</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class InclusionExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(InclusionPackage.eNS_URI, 
			 InclusionPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.inclusion"));
				MachineInclusion root = InclusionFactory.eINSTANCE.createMachineInclusion();
